...
#### 2.1 项目初始化
- [ ] 创建 `server/` 目录
- [ ] 安装依赖 (Express, MongoDB, JWT, bcrypt)
- [ ] 配置环境变量
...
| Phase 2: 后端搭建 | 2-3 周 | 🚧 进行中 | 🔴 高 |
| Phase 3: 管理控制台 | 1-2 周 | 📅 计划中 | 🟡 中 |
| Phase 4: 高级功能 | 2-3 周 | 📅 计划中 | 🟢 低 |
